...
-- ve aynı zamanda bu ürünleri NİSAN ayında alan musteri_isim'lerini listeleyini
...
--NOT:fetch next row only komutu limitle ayni isi yapar
...
select kitap_isim , yazar_isim from yazarlar as A
right join kitaplar as B
