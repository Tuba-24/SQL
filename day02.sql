...
delete from kursiyerler where isim in('Derya Soylu','Yavuz Bal'); --yukaridaki kodla ayni isi yapar.
...
DDL(Data Definition Language) Grubundan==> ALTER komutu tabloyu günceller.
