...
insert into memurlar values (5,'Altug', 25000, 'Yuksek Lisans'); --UNIQUE SEBEBİYLE EROR VERİR
...
/*
NOT: CONSTRAINT'leri sutun isimlerinin altında belirtmenin bize sagladıgı avantaj;
...
insert into emekciler values(10009, 'Cem', '');--INTEGER  
